export const enUS = {
  ...
  missions: {
    ...
    noMissionsYet: "No research missions yet",
    noMissionsDesc: "Create your first mission to start deep research.",
    createNew: "Create Research Mission",
    createNewDesc: "Describe what you want to research. The AI will plan and execute a deep research workflow.",
    queryLabel: "Research Query",
    queryPlaceholder: "What would you like to research? Describe your question or topic in detail...",
    titlePlaceholder: "Give your mission a title (auto-generated if left empty)",
    depthLabel: "Research Depth",
    depthPlaceholder: "Select research depth",
    selectNotebook: "Select a notebook",
    noNotebook: "No notebook",
    createSuccess: "Research mission created successfully",
    startSuccess: "Research mission started",
    deleteSuccess: "Research mission deleted successfully",
    startResearch: "Start Research",
    deleteMission: "Delete Mission",
    deleteConfirm: "Are you sure you want to delete this research mission? This action cannot be undone.",
    notFound: "Mission not found",
    reportNotReady: "Research not yet complete. Start the mission to generate a report.",
    noNotesYet: "No research notes yet",
